  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-headline-md text-headline-md text-primary">Deneyim</h2>
          <p className="font-body-md text-on-surface-variant mt-1">İş deneyimlerinizi yönetin.</p>
        </div>
        <Link href="/admin/experience/new" className="btn-primary px-6 py-3 rounded-full font-label-md flex items-center gap-2">
      ...
      {items && items.length > 0 ? (
            ...
            <div key={item.id} className="glass-panel p-6 rounded-2xl flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="font-body-md text-on-surface-variant">{item.company}</p>
        ...
        <div className="glass-panel p-12 rounded-3xl text-center">
          <span className="material-symbols-outlined text-6xl text-on-surface-variant/30 mb-4">work</span>
          <p className="font-body-md text-on-surface-variant mb-4">Henüz deneyim eklenmedi.</p>
          <Link href="/admin/experience/new" className="btn-primary px-6 py-3 rounded-full font-label-md">İlk Deneyimi Ekle</Link>
        </div>
      )}
    </div>
  );
